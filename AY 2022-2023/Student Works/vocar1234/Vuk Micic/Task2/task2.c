...
//lore of the game is before he was hung one arm and one leg was chopped off (idk how to print backslash \)
...
int main(){
    ...
    //!!!add check to stop user from inputing same letters
