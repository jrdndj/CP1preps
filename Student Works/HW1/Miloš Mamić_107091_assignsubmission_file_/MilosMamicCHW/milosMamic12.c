...
int main()
{
    ...
    while (number != 0)
    {       //if number is 1000 print M
        if (number >= 1000)
        {
            postdigit('M', number / 1000);
            number = number - (number / 1000) * 1000;
        }       //if number is 500 print D
        else if (number >= 500)
        {
            if (number < (500 + 4 * 100))
            {
        ...
        {   //if number is  less then print I
            if (number < 4)
            {
